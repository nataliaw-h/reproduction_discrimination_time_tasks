...
<div id="6">
    <section2>
        <center>Kliknij dalej aby przejść do drugiego badania.</center>
        <p><center><button style=" width: 400px; height: 100px; background-color: #e3fbe3; border-radius: 40%" onclick="secondStudy()">DALEJ</button></center></p>
    </section2>
</div>
...
$sql = "INSERT INTO wyniki (id, w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15, w16, w17, w18, w19, w20, w21, w22, w23, w24, w25, w26, w27, w28, w29, w30)
